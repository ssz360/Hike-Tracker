    ...
    return(
        <>
            ...
            <MapContainer bounds={props.bounds} style={{width:"auto",height:"70vh"}} scrollWheelZoom={true}>
                ...
                {getMarkerForPoint(props.hike.startPoint,true,false,props.selectedPoint===props.hike.startPoint.id,true,props.selectedPoint,props.setSelectedPoint)}
                {getMarkerForPoint(props.hike.endPoint,false,true,props.selectedPoint===props.hike.endPoint.id,true,props.selectedPoint,props.setSelectedPoint)}
            </MapContainer>
            }
        </>
    )
